class MockCompletionStreamResponse < Instruct::Gen::CompletionResponse
  ...
  def initialize(text = nil, stream_chunks: nil, finish_reason: nil, completion: Instruct::Transcript::Completion.new(duped_transcript: Instruct::Transcript.new), **kwargs)
    if text.is_a?(Array)
